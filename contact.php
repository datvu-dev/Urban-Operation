...
<h5><?php _e('What\'s your Name?', 'WEBNUS_TEXT_DOMAIN'); ?></h5>
<input name="txtName" type="text" class="txbx" value="<?php _e('Name', 'WEBNUS_TEXT_DOMAIN'); ?>" /><br />
<h5><?php _e('What\'s your Email?','WEBNUS_TEXT_DOMAIN') ?></h5>
