...
<?php } ?>
		...
		if( 0 != $logo_rightside )
		{
			...
			{
			?>
				<div class="col-md-5 col-sm-7 alignright"><hr class="vertical-space" /><h6><i class="icomoon-envelop-2"></i> <?php echo $webnus_options->webnus_header_email(); ?></h6> <h6><i class="icomoon-phone-2"></i> <?php echo $webnus_options->webnus_header_phone(); ?></h6></div>
		<?php 
			}
