...
<?php endif; ?>
	<!-- CSS + JS
  ================================================== -->
  <link rel='stylesheet' href="<?php bloginfo( 'template_directory' );?>/custom-style.css" type='text/css' media='all' />
  
<?php wp_head();  ?>
	<script type="text/javascript" src='<?php bloginfo( 'template_directory' );?>/custom-script.js'></script>
</head>
<?php
/*
...
<body <?php body_class('default-header '. $transparent_header_class); ?>>
	<!-- Primary Page Layout
	================================================== -->
<div id="enquiry-container"><div id="enquiry-layer"></div><?php echo do_shortcode('[contact-form-7 id="123" title="Enquiry Form 1"]'); ?></div>
