...
wp_register_style( 'webnus_js_composer', get_template_directory_uri() .'/inc/visualcomposer/assets/webnus_js_composer.css', array('isotope-css', 'animate-css', 'bootstrap_modals'),false, false );
