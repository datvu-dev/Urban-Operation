...
function ourteam1_shortcode ($atts, $content = null) {
	...
	if(!empty($first_url))
		$out .= '<a href="'. $first_url .'"><i class="icomoon-'. $first_social .'"></i></a>';
	if(!empty($second_url))
		$out .= '<a href="'. $second_url .'"><i class="icomoon-'. $second_social .'"></i></a>';
	if(!empty($third_url))
		$out .= '<a href="'. $third_url .'"><i class="icomoon-'. $third_social .'"></i></a>';
	if(!empty($fourth_url))
		$out .= '<a href="'. $fourth_url .'"><i class="icomoon-'. $fourth_social .'"></i></a>';
	$out .= '</div>';
	$out .= '</article>';
