...
function setup_framework_options() {
    ...
    $sections[] = array(
        ...
        'fields' => array(
            ...
            array(
                'id' => 'webnus_custom_font1_svg',
                'type' => 'upload',
                'title' => __('Custom font 1 .svg', WEBNUS_TEXT_DOMAIN),
                'desc' => __('Upload the .svg font file for custom font 1', WEBNUS_TEXT_DOMAIN),
                'options' => $fontArray
            ),            
            array(
            ...
            array(
                'id' => 'webnus_custom_font2_svg',
                'type' => 'upload',
                'title' => __('Custom font 2 .svg', WEBNUS_TEXT_DOMAIN),
                'desc' => __('Upload the .svg font file for custom font 2', WEBNUS_TEXT_DOMAIN),
                'options' => $fontArray
            ),            
            array(
            ...
            array(
                'id' => 'webnus_custom_font3_svg',
                'type' => 'upload',
                'title' => __('Custom font 3 .svg', WEBNUS_TEXT_DOMAIN),
                'desc' => __('Upload the .svg font file for custom font 3', WEBNUS_TEXT_DOMAIN),
                'options' => $fontArray
            ),            
            array(
